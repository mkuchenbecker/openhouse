...
/**
 * Spark-4.0 / Iceberg-1.11 / REST-first port of the 3.5 lane's {@code e2e/BranchJavaTest}. Uses the
 * Iceberg Java API (branch create / append-to-branch / cherry-pick / expire / stageOnly) obtained
 * from the Spark catalog plugin via {@link HasIcebergCatalog} — which on this lane is the stock
 * {@code SparkCatalog} wrapping a {@code RESTCatalog}. Ports verbatim; only the base class changes.
 */
public class BranchJavaTestSpark4_0 extends OpenHouseRestSparkITest {
