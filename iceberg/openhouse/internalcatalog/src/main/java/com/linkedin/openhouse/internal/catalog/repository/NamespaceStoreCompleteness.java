...
public interface NamespaceStoreCompleteness {
   ...
   * @throws RuntimeException if the state cannot be read; an unreachable House Tables is not
   *     evidence of completeness and must not be reported as any answer at all.
   */
