 ...
 */
@Component
public class CadenceBasedOrphanFilesDeletionAnalyzer extends CadenceBasedAnalyzer {
  ...
  CadenceBasedOrphanFilesDeletionAnalyzer(CadencePolicy cadencePolicy) {
    super(OperationTypeDto.ORPHAN_FILES_DELETION, OFD_ENABLED_PROPERTY, cadencePolicy);
  }
}
