...
class CadenceBasedDataLayoutStrategyGenerationAnalyzerTest {
  ...
  private CadenceBasedDataLayoutStrategyGenerationAnalyzer analyzer;

  @BeforeEach
  void setUp() {
    analyzer =
        new CadenceBasedDataLayoutStrategyGenerationAnalyzer(
            new CadencePolicy(TEST_SUCCESS_INTERVAL, TEST_FAILURE_INTERVAL));
  }

  @Test
  void operationType_isGeneration() {
    assertThat(analyzer.getOperationType())
        .isEqualTo(OperationTypeDto.DATA_LAYOUT_STRATEGY_GENERATION);
  }
  ...
  private TableDto tableWithProperty(boolean enabled) {
    return TableDto.builder()
        ...
        .tableProperties(
            Map.of(
                CadenceBasedDataLayoutStrategyGenerationAnalyzer.DLS_GENERATION_ENABLED_PROPERTY,
  ...
  private TableOperationsHistoryDto historyWithStatus(
    ...
    return TableOperationsHistoryDto.builder()
        .id("hist-id")
        .tableUuid("test-uuid")
        .operationType(OperationTypeDto.DATA_LAYOUT_STRATEGY_GENERATION)
