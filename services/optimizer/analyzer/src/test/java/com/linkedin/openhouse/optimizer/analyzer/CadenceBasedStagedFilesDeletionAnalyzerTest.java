...
class CadenceBasedStagedFilesDeletionAnalyzerTest {
  ...
  private CadenceBasedStagedFilesDeletionAnalyzer analyzer;

  @BeforeEach
  void setUp() {
    analyzer =
        new CadenceBasedStagedFilesDeletionAnalyzer(
  ...
  @Test
  void getOperationType_returnsStagedFilesDeletion() {
    assertThat(analyzer.getOperationType()).isEqualTo(OperationTypeDto.STAGED_FILES_DELETION);
  }
  ...
  private TableDto tableWithProperty(boolean enabled) {
    return TableDto.builder()
        ...
        .tableProperties(
            Map.of(
                CadenceBasedStagedFilesDeletionAnalyzer.SFD_ENABLED_PROPERTY,
  ...
  private TableOperationsHistoryDto historyWithStatus(
    ...
    return TableOperationsHistoryDto.builder()
        .id("hist-id")
        .tableUuid("test-uuid")
        .operationType(OperationTypeDto.STAGED_FILES_DELETION)
