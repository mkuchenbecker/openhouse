# TLA+ Formalization of the OpenHouse Commit Protocol

Artifacts (all under `/tmp/claude-0/-home-user/23660f9e-df90-56f6-9c2f-b48ac8eca3bf/scratchpad/tla/`):
...
| `tla2tools.jar` | TLC (latest release, run under OpenJDK 21.0.10) |

Inputs: reports `01-openhouse-commit-protocol.md` and `02-snapshot-drop-bug.md` (file:line references below use their conventions; `ITO` = `OpenHouseInternalTableOperations.java`, `REPO` = `OpenHouseInternalRepositoryImpl.java`, all at HEAD `2a9dac8` of `/home/user/openhouse`).
...
```
cd /tmp/claude-0/-home-user/23660f9e-df90-56f6-9c2f-b48ac8eca3bf/scratchpad/tla
